...
![](/assets/images/projects/project01/cloudflare_add-button.png "Add Site Button")

Next, click the hyperlink to "register a new domain".  
![](/assets/images/projects/project01/cloudflare_register-new-domain.png "Register new domain")
...
![](/assets/images/projects/project01/cloudflare_search-for-domain.png "Search for a domain")
...
![](/assets/images/projects/project01/cloudflare_sidebar-websites.png "Sidebar - Websites")
...
![](/assets/images/projects/project01/cloudflare_sidebar-DNS.png "Sidebar - DNS")
...
![](/assets/images/projects/project01/cloudflare_DNS-records-overview.png "Sidebar - DNS")


For now, we're finished here and can move on to [Creating the M365 Environment]!


[getting started page]: (https://developers.cloudflare.com/registrar/get-started/register-domain/)
