...
Fill out the required sections and check the "I accept" box for the TOC and click "Next".  
...
Next, you will asked to select your interests within the Developer Program.
...
After completing the initial setup of our Dev Environment, we will now activate the included M365 E5 Sandbox. You should automatically have this popup appear to complete this portion of the setup.  

We will be choosing the "Configurable sandbox" option so that we can use the custom domain we just purchased. Click "Next".
...
Complete the required security setup process with your information as required.  
